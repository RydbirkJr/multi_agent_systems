...
\*******************************************************/
    ...
    * Important for Unix systems *
    ...
    GuiClient works by creating a joint action of identical individual actions for each agent on the level; e.g. clicking Move(W) on a level with 3 agentActors sends [Move(W),Move(W),Move(W)].
    ...
    The argument passed to random_agent.rb is the number of agentActors on the level
